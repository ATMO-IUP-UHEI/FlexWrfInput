...
from flexwrfinput import default_config
...
class Outgrid:
    ...
    def set_wrf_heights(
        self, wrfinput_path: Union[str, Path], until: Optional[int] = None
    ):
        """Reads level heights from wrfinput_d0... files and assignes them as levels of the outgrid.

        Args:
            wrfinput_path (Union[str, Path]): Path to wrfinput file.
            until (Optional[int]): Index of highest layer to include. By default uses all layers.
        """
